                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="">
                                    ...
                                    <ul <?php if($page =='surveiGuru'||$page =='surveiKegiatan'):?>class="mm-show"<?php endif;?>>
                                        <li><a <?php if($page =='surveiGuru'):?>class="mm-active"<?php endif;?>href="<?= base_url(); ?>admin/surveiGuru">Survei Mahasiswa</a></li>
                                        <li><a <?php if($page =='surveiKegiatan'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/surveiKegiatan">Survei Kegiatan Mahasiswa</a></li>
                                    </ul>
                                </li>
                                <li class="">
                                    <a href="#">
                                    ...
                                    <ul <?php if($page =='tbhKuesionerGuru'||$page =='tbhKuesionerKegiatan'||$page =='tbhKuesionerKepuasan'):?>class="mm-show"<?php endif;?>>
                                        <li><a <?php if($page =='tbhKuesionerGuru'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/KuesionerGuru">Tambah Survei Dosen</a></li>
                                        <li><a <?php if($page =='tbhKuesionerKegiatan'):?>class="mm-active"<?php endif;?>href="<?= base_url(); ?>admin/KuesionerKegiatan">Tambah Survei Kegiatan Mahasiswa</a></li>
                                ...
                                <li>
                                    ...
                                    <ul <?php if($page =='tbhDataSiswa'||$page =='siswaNonRegis'||$page =='userSiswa'):?>class="mm-show"<?php endif;?>>
                                        <li><a <?php if($page =='tbhDataSiswa'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/tbhDataSiswa">Tambah Data Mahasiswa</a></li>
                                        <li><a <?php if($page =='siswaNonRegis'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/siswaNonRegis">Mahasiswa Belum Regist</a></li>
                                        <li><a <?php if($page =='userSiswa'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/userSiswa">User Mahasiswa</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <ul <?php if($page =='kelas'||$page =='guru'||$page =='pertanyaan'||$page =='aspekGuru'||$page =='kepuasan'):?>class="mm-show"<?php endif;?>>
                                        ...
                                        <li><a <?php if($page =='guru'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/guru">Dosen</a></li>
                                        <li><a <?php if($page =='pertanyaan'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/pertanyaan">Survei Kepuasan</a></li>
                                        <li><a <?php if($page =='aspekGuru'):?>class="mm-active"<?php endif;?> href="<?= base_url(); ?>admin/aspekGuru">Survei Dosen </a></li>
                ...
                <div class="app-main__inner">
                    ...
                    <div class="app-header">
                        <div class="page-title-heading">
                            Angket Kepuasan Mahasiswa Universitas Ibrahimy
