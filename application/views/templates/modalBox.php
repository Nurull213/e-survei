            ...
            <div class="form">
                <div class="">
                    <div class=" form-group">
                        <label for="" class="">Nama Dosen <span><i class="text-danger">*</i></span></label>
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('admin/updateUser');?>" method="post">
            <div class="form">
                <div class="">
                    <div class=" form-group">
                        <label for="" class="">Nama Mahasiswa <span><i class="text-danger">*</i></span></label>
                        <input name="nama" id="nama" type="" class="form-control text-danger" required>
                    </div>
                </div>
                <div class="">
                    <div class=" form-group">
                        <label for="" class="">NIM <span><i class="text-danger">*</i></span></label>
...
<div class="modal fade" id="nonRegis" tabindex="-1" role="dialog" aria-labelledby="user" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="user">Edit Mahasiswa Non Regis</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
